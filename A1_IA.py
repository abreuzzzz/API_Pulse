...
# Configurar sua API Key do DeepSeek
...
SHEET_ID2 = "1IJNuQ_JrXLdbOWleYZDoEk1JSwA135YEl_g9mGrrEzk"  # ID da planilha de destino
...
df['Trimestre'] = df['Column1.cabecTitulo.dDtPagamento'].dt.to_period('Q')
...
rentabilidade['lucro'] = rentabilidade['Total_omie_receita'] - rentabilidade['Total_omie_despesa']
...
spreadsheet = gc.open_by_key("1IJNuQ_JrXLdbOWleYZDoEk1JSwA135YEl_g9mGrrEzk")
